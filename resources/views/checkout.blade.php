                ...
                <div class="checkout__totals-wrapper">
                    <div class="sticky-content">
                        ...
                        <div class="checkout__payment-methods">
                            ...
                            <div class="form-check">
                                <input class="form-check-input form-check-input_fill" type="radio" name="mode" value="phonepay" id="mode2">
                                <label class="form-check-label" for="mode2">
                                    PhonePay                                    
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input form-check-input_fill" type="radio" name="mode" value="cod" id="mode3" checked>
