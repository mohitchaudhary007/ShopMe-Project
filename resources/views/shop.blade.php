    ...
    <section class="shop-main container d-flex pt-4 pt-xl-5">
      <div class="shop-sidebar side-sticky bg-body" id="shopFilter">
        ...
        <div class="accordion" id="price-filters">
            ...
            <button class="accordion-button p-0 border-0 shadow-none collapsed" type="button" data-bs-toggle="collapse"
                data-bs-target="#accordion-filter-price" aria-expanded="true" aria-controls="accordion-filter-price">
              PRICE
              <svg class="accordion-button__icon" width="10" height="11" viewBox="0 0 10 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M4.40206 0.65332H5.59794V7.85973L8.59665 4.84761L9.41401 5.66908L5 10.1035L0.585991 5.66908L1.40335 4.84761L4.40206 7.85973V0.65332Z" fill="black"/>
                </svg>
              </button>
            </h5>
            ...
            @else
                <div class="col-12 text-center py-5">
                    <div class="alert alert-info">
                        ...
                        <p>There are currently no products available in the shop. Please check back later.</p>
                    </div>
                </div>
            @endif
        </div>
...
<script>
  $(function(){
    ...
    // Add AJAX form submission for add to cart
    $('.add-to-cart-form').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                // Change button to "Go to Cart" button
                form.replaceWith('<a href="{{route("cart.index")}}" class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium btn-warning mb-3">Go to Cart</a>');
                
                // Show success message
                $('<div class="alert alert-success position-fixed top-0 start-50 translate-middle-x mt-3 px-4 py-2" style="z-index: 9999;">Product added to cart successfully!</div>')
                    .appendTo('body')
                    .delay(2000)
            ...
            error: function() {
                ...
                // Show error message
                $('<div class="alert alert-danger position-fixed top-0 start-50 translate-middle-x mt-3 px-4 py-2" style="z-index: 9999;">Failed to add product to cart.</div>')
                    .appendTo('body')
                    .delay(2000)
                    .fadeOut(500, function() {
                        $(this).remove();
