...
@section('content')
<style>
    .dot.t1 { background-color: #2377FC; }
    .dot.t2 { background-color: #FFA500; }
    .dot.t3 { background-color: #078407; }
    .dot.t4 { background-color: #FF0000; }
    
    /* Custom rupee icon */
    .icon-dollar-sign.rupee:before {
            ...
            <div class="w-half">
                ...
                <div class="wg-chart-default mb-20">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap14">
                            <div class="image ic-bg">
                                <i class="icon-dollar-sign rupee"></i>
                            </div>
                            <div>
