...
@section('content')
  <main>
    ...
    @else
    <section class="welcome-banner py-5 mt-5 text-center">
      <div class="container">
        <div class="bg-light p-5 rounded">
          <h2 class="section-title">Welcome to Our Shop</h2>
          <p class="lead">Discover our latest collection of fashion and accessories.</p>
