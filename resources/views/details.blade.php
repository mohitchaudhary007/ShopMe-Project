            ...
            <div class="col-lg-5">
                <div class="d-flex justify-content-between mb-4 pb-md-2">
                    ...
                    <div class="product-single__prev-next d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1">
                        @php
                            $prevProduct = App\Models\Product::where('id', '<', $product->id)->orderBy('id', 'desc')->first();
                            $nextProduct = App\Models\Product::where('id', '>', $product->id)->orderBy('id', 'asc')->first();
                        @endphp
                        
                        @if($prevProduct)
                            <a href="{{ route('shop.product.details', ['product_slug' => $prevProduct->slug]) }}" class="text-uppercase fw-medium"><svg width="10" height="10" viewBox="0 0 25 25" xmlns="http://www.w3.org/2000/svg">
                                <use href="#icon_prev_md" />
                            </svg><span class="menu-link menu-link_us-s">Prev</span></a>
                        @else
                            <span class="text-uppercase fw-medium text-muted"><svg width="10" height="10" viewBox="0 0 25 25" xmlns="http://www.w3.org/2000/svg">
                                <use href="#icon_prev_md" />
                            </svg><span class="menu-link menu-link_us-s">Prev</span></span>
                        @endif
                        
                        @if($nextProduct)
                            <a href="{{ route('shop.product.details', ['product_slug' => $nextProduct->slug]) }}" class="text-uppercase fw-medium"><span class="menu-link menu-link_us-s">Next</span><svg width="10" height="10" viewBox="0 0 25 25" xmlns="http://www.w3.org/2000/svg">
                                <use href="#icon_next_md" />
                            </svg></a>
                        @else
                            <span class="text-uppercase fw-medium text-muted"><span class="menu-link menu-link_us-s">Next</span><svg width="10" height="10" viewBox="0 0 25 25" xmlns="http://www.w3.org/2000/svg">
                                <use href="#icon_next_md" />
                            </svg></span>
                        @endif
                    </div><!-- /.shop-acs -->
                ...
                <div class="product-single__addtolinks">
                    ...
                    <form action="{{route('wishlist.item.remove',['rowId'=>Cart::instance('wishlist')->content()->Where('id',$product->id)->first()->rowId])}}" method="POST" id="frm-remove-item">
                        ...
                        <a href="javascript:void(0)" class="menu-link menu-link_us-s add-to-wishlist filled-heart" onclick="document.getElementById('frm-remove-item').submit();"><svg width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <use href="#icon_heart" />
                            </svg><span>Remove to Wishlist</span>
                        </a>
                    </form>
                    @else
