...
<head>
  ...
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
    <meta name="author" content="LaravelEcommerce" />
  <link rel="stylesheet" type="text/css" href="{{ asset('css/animate.min.css') }}">
    ...
    <link rel="shortcut icon" href="{{ asset('images/faviconIcon.ico')}}" type="image/x-icon">
    <link rel="apple-touch-icon-precomposed" href="{{ asset('images/faviconIcon.ico') }}">
                ...
                <div class="section-content-right">
                                    ...
                                    <div class="dropdown">
                                        <button class="btn btn-secondary dropdown-toggle" type="button"
                                            ...
                                            <span class="header-user wg-user">
                                                <span class="image">
                                                    <img src="images/avatar/keshav-image.png" alt="">
                                                </span>
                                                <span class="flex flex-column">
                                                    <span class="body-title mb-2">Keshav Sharma</span>
                    ...
                    <div class="main-content">
                        ...
                        <div class="bottom-page">
                            <div class="body-text">Copyright © 2025 Laravel Ecommerce</div>
                        </div>
                    </div>
