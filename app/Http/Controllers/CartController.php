...
class CartController extends Controller
{
    ...
    public function apply_coupon_code(Request $request)
    {
        ...
        if (isset($coupon_code)) {
            // Convert Cart subtotal from string to float for proper comparison
            ...
            if (!$coupon) {
                return back()->with('error', 'Invalid coupon code or minimum purchase amount not met!');
            }
    ...
    public function calculateDiscounts()
    {
        ...
        if (Session::has('coupon')) {
            // Convert Cart subtotal from string to float for calculations
            $cartSubtotal = floatval(str_replace(',', '', Cart::instance('cart')->subtotal()));
